...
# --- App Configuration ---
st.set_page_config(
    page_title="Advanced Google Playstore Reviews Analyzer",
    page_icon="🔬",
    layout="wide",
)
...
def summarize_texts(texts, sentences_count=2):
    ...
    try:
        ...
        st.warning("Could not generate a summary for this cluster due to an internal tokenizer error. A raw text snippet is shown instead.")
...
# --- Streamlit UI ---
st.title("🔬 Advanced Google Play Reviews Analyzer")
